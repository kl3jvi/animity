...
private class BooleanPreference(
    ...
    override fun getValue(
        ...
        property: KProperty<*>,
    ): Boolean = thisRef.preferences.getBoolean(key, default)
...
private class FloatPreference(
    ...
    override fun getValue(
        thisRef: PreferencesHolder,
        property: KProperty<*>,
    ): Float = thisRef.preferences.getFloat(key, default)
...
private class IntPreference(
    ...
    override fun getValue(
        thisRef: PreferencesHolder,
        property: KProperty<*>,
    ): Int = thisRef.preferences.getInt(key, default)
...
private class LongPreference(
    ...
    override fun getValue(
        thisRef: PreferencesHolder,
        property: KProperty<*>,
    ): Long = thisRef.preferences.getLong(key, default)
...
private class StringSetPreference(
    ...
    override fun getValue(
        thisRef: PreferencesHolder,
        property: KProperty<*>,
    ): Set<String> = thisRef.preferences.getStringSet(key, default) ?: default
...
fun booleanPreference(
    key: String,
    default: Boolean,
): ReadWriteProperty<PreferencesHolder, Boolean> = BooleanPreference(key, default)

fun floatPreference(
    key: String,
    default: Float,
): ReadWriteProperty<PreferencesHolder, Float> = FloatPreference(key, default)

fun intPreference(
    key: String,
    default: Int,
): ReadWriteProperty<PreferencesHolder, Int> = IntPreference(key, default)

fun longPreference(
    key: String,
    default: Long,
): ReadWriteProperty<PreferencesHolder, Long> = LongPreference(key, default)
...
fun <T : Enum<T>> enumPreference(
    key: String,
    default: T,
): ReadWriteProperty<PreferencesHolder, T> = EnumPreference(key, default)
