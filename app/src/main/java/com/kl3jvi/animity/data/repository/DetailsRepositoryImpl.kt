...
constructor(
    ...
    override fun fetchEpisodeList(
        ...
        return combine(
            ...
            persistenceRepository.getDownloadedEpisodesForAnime(malId)
        ) { episodeModels, episodeEntities, downloadedEpisodes ->
            ...
            episodeModels.map { episode ->
                ...
                // change download status for episode
                val downloadedEpisode =
                    downloadedEpisodes.find { it.episodeNumber == episode.getEpisodeNumberAsString() }
                episode.isDownloaded = downloadedEpisode == null
                episode
            }
        }.flowOn(ioDispatcher)
    }

    override fun changeAnimeStatus(
        mediaId: Int,
    ...
    private fun getEpisodeTitles(id: Int) =
        flow {
            val response =
    ...
    private fun getEpisodesPercentage(malId: Int) =
        episodeDao.getEpisodesByAnime(malId = malId)
