...
private fun NotificationsQuery.OnThreadCommentReplyNotification.toNotification() =
    Notification(
        id = this.id,
        episode = null,
        createdAt = createdAt,
...
private fun NotificationsQuery.OnThreadCommentMentionNotification.toNotification() =
    Notification(
        type = NotificationType.Threads,
        id = this.id,
        episode = null,
...
private fun NotificationsQuery.OnActivityMentionNotification.toNotification() =
    Notification(
        type =
...
private fun NotificationsQuery.OnActivityReplyNotification.toNotification() =
    Notification(
        type =
        NotificationType.Activity(
            User(
...
private fun NotificationsQuery.OnAiringNotification.toNotification() =
    Notification(
...
private fun NotificationsQuery.OnFollowingNotification.toNotification() =
    Notification(
        type =
...
private fun NotificationsQuery.OnActivityLikeNotification.toNotification() =
    Notification(
        type =
        NotificationType.Activity(
            User(
...
private fun NotificationsQuery.OnActivityMessageNotification.toNotification() =
    Notification(
        type =
        NotificationType.Activity(
            User(
...
private fun NotificationsQuery.Media?.convert(): AniListMedia {
    return AniListMedia(
        ...
        startDate =
        if (this?.homeMedia?.startDate?.year != null) {
            FuzzyDate(
